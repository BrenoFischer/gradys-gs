...
@send_cmds_to_uav.route('/experiment')
def flask_experiment():
    logger = get_logger()
    copter = get_copter_instance()
    args = get_args()

    logger.log_info(f'Drone {args.uav_sysid}', f'Route /experiment reached from drone {args.uav_sysid}')
    print("Let's wait ready to arm")
    # We wait that can pass all arming check
    logger.log_info(f'Drone {args.uav_sysid}', f'Waiting that drone can pass all arming check')
    copter.wait_ready_to_arm()
    ...
    logger.log_info(f'Drone {args.uav_sysid}', f'Adding waypoints to the mission')
    copter.add_wp_takeoff(last_home.lat, last_home.lng, 10)
    copter.add_waypoint(-15.84034160, -47.92689080, 20.000000)
    copter.add_waypoint(-15.84027450, -47.92749170, 30.000000)
    copter.add_waypoint(-15.83987200, -47.92759900, 40.000000)
    copter.add_waypoint(-15.83977910, -47.92700890, 50.000000)
    copter.add_waypoint(-15.84028680, -47.92690830, 60.000000)
    copter.add_waypoint(-15.84023450, -47.92746620, 60.000000)
    copter.add_waypoint(-15.83990040, -47.92755200, 60.000000)
    copter.add_waypoint(-15.83982170, -47.92705180, 60.000000)
    copter.add_waypoint(-15.84021650, -47.92697400, 55.000000)
    copter.add_waypoint(-15.84016870, -47.92741920, 50.000000)
    copter.add_waypoint(-15.83992880, -47.92749030, 45.000000)
    copter.add_waypoint(-15.83987720, -47.92710000, 40.000000)
    copter.add_waypoint(-15.84014290, -47.92704370, 35.000000)
    copter.add_waypoint(-15.84013260, -47.92738440, 30.000000)
    copter.add_waypoint(-15.83996750, -47.92742330, 25.000000)
    copter.add_waypoint(-15.83993780, -47.92714830, 20.000000)
    # We add a RTL at the end.
    logger.log_info(f'Drone {args.uav_sysid}', f'Adding RTL at the end')
    copter.add_wp_rtl()
    ...
    copter.wait_landed_and_disarmed(min_alt=2)
    logger.log_info(f'Drone {args.uav_sysid}', f'Mission completed and drone landed and disarmed')
    logger.log_info(f'Drone {args.uav_sysid}', f'End of /experiment route')
